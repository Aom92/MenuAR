    ...
    public void FoodTextUpdate()
    {
        ...
        switch (DispFoodReference.foodIndex)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                dishName.text = "Nachos con queso";
                dishDescription.text = "Chips de tortilla de maiz local, crujientes y dorados, acompañados de " +
                                       "delicioso queso fundido de leche 100% orgánica.";
                dishPrice.text = ". . . 69 MXN";

                break;
            case 4:
                dishName.text = "Galletas de Chocolate";
                dishDescription.text = "Dulces y crujientes galletas de chocolate. Acompañados de relleno cremoso.";
                dishPrice.text = ". . . 25 MXN";
                break;
            default:
                break;
        }
